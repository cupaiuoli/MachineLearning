...
for iter = 1:num_iters
    ...
    error_vector = hipotesis - y;
    
    % 3 - The change in theta (the "gradient") is the sum of the product of X and the "errors vector",
    % scaled by alpha and 1/m. Since X is (m x n), and the error vector is (m x 1), 
    ...
    sum_theta_err = X' * error_vector;
    theta_change = alpha * (1/m) * sum_theta_err;
